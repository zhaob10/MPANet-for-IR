...
parser.add_argument('--weights', default='./pretrained_models/denoising/model_best.pth',
...
#DND中的图像存放在'./datasets/dnd/input'中，格式为.png, 都是大小为512×512的图像块，一张高分辨率的DND图像被切成20个块


os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"
os.environ["CUDA_VISIBLE_DEVICES"] = args.gpus

utils.mkdir(args.result_dir+'matfile')  #mat文件存放位置
utils.mkdir(args.result_dir+'png')  #png文件存放位置
