...
from networks.derain_mulcmp import OUCD
...
parser.add_argument('--input_dir', default='../SPAD_patches/val',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/deraining/OUCD4/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='./checkpoints/Deraining/models/OUCD/model_best.pth',
